...
export const metadata: Metadata = {
  title: "Automatic Brick Making Machine | Vagheshwari Engineering Works",
  description:
    "Buy automatic bricks making machine at best price in India. High capacity, durable, low maintenance. Call now for price & demo.",
  alternates: {
    canonical: "https://www.vagheshwariengineering.com/products",
  },
};
